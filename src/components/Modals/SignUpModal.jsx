const SignUpModal = () => {
    return (
        <>
            {/* <!-- popup register --> */}
            <div className="modal modal-account fade" id="modalRegister" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="flat-account">
                            <div className="banner-account">
                                <img src="https://homelengo.vercel.app/images/banner/banner-account2.jpg" alt="banner" />
                            </div>
                            <form className="form-account">
                                ...
                                <div className="box box-btn">
                                    <a href="dashboard.html" className="tf-btn primary w-100">Sign Up</a>
                                    <div className="text text-center">Don’t you have an account? <a href="#modalLogin" data-bs-toggle="modal" className="text-primary">Sign In</a></div>
                                </div>
                                {/* <p className="box text-center caption-2">or login with</p>
                                <div className="group-btn">
                                    <a href="#" className="btn-social">
                                        <img src="https://homelengo.vercel.app/images/logo/google.jpg" alt="img" />
                                        Google
                                    </a>
                                    <a href="#" className="btn-social">
                                        <img src="https://homelengo.vercel.app/images/logo/fb.jpg" alt="img" />
                                        Facebook
                                    </a>
                                </div> */}
                            </form>
